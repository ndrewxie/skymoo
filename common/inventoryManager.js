(function(exports) {
	...
	InventoryManager.prototype.setChoices = function(primary, secondary, trapBoost) {
		this.actionBarItems = [];
		...
		if (trapBoost == config.getTypeByName("Boost Pads")) {
			this.setActionBarItem(6, new ItemSlot(config.getTypeByName("Boost Pads"), undefined));
		}
		else {
			this.setActionBarItem(6, new ItemSlot(config.getTypeByName("Pit Trap"), undefined));
		}
	}
