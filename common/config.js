(function(exports) {
    ...
    const MOVE_SPEED = 4.75 * TICK_CONSTANT;
    exports.MOVE_SPEED = MOVE_SPEED;
    const DECEL_FACTOR = 0.27;
    ...
    var unifiedItems = [
        ...
        },
        {
            ...
            vertical: true,
            allows: ["Wrench"],
            description: "Long range, high damage, slow fire-rate ranged weapon, with negative knockback",
        },
        {
            name: "Rifle Round",
            action: getActionByName("projectile"),
